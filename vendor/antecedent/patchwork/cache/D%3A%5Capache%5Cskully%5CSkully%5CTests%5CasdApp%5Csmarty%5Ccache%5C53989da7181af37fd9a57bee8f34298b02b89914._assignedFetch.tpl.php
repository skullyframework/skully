<?php  \Patchwork\Interceptor\applyScheduledPatches();/*%%SmartyHeaderCode:978854b80380884d87-25553421%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
